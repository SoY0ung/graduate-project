...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.camRecoBtn.sizePolicy().hasHeightForWidth())
        self.camRecoBtn.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.fileRecoBtn.sizePolicy().hasHeightForWidth())
        self.fileRecoBtn.setSizePolicy(sizePolicy)
        ...
        spacerItem3 = QtWidgets.QSpacerItem(0, 10, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.rootVLayout.addItem(spacerItem3)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.openFaceMgrBtn.sizePolicy().hasHeightForWidth())
        self.openFaceMgrBtn.setSizePolicy(sizePolicy)
        ...
        self.faceMgrFuncHLayout.addItem(spacerItem4)
        self.faceIdentityBtn = QtWidgets.QPushButton(self.centralwidget)
        self.faceIdentityBtn.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.faceIdentityBtn.sizePolicy().hasHeightForWidth())
        self.faceIdentityBtn.setSizePolicy(sizePolicy)
